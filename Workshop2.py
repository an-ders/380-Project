    ...
    while True:
        ...
        if lines is not None:
            ...
            for line in lines:
                ...
                points.append((x1, y1))
                points.append((x2, y2))
                cv.line(frame, (x1, y1), (x2, y2), (0, 0, 255), 2)  # Draw line in green
            ...
            # Draw the highest point (smallest y) in red
            # Get frame width
            frame_width = frame.shape[1]  
            
            # Draw horizontal line at the highest y-value (topmost detected edge)
            cv.line(frame, (0, highest_point[1]), (frame_width, highest_point[1]), (255, 255, 0), 2)  # Cyan
            
            # Draw horizontal line at the lowest y-value (bottommost detected edge)
            cv.line(frame, (0, lowest_point[1]), (frame_width, lowest_point[1]), (255, 255, 0), 2)  # Cyan
